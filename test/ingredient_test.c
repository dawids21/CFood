...
void add_ingredient_fail_if_ingredient_with_the_same_name_and_type_already_exists() {
    add_ingredient(service, "Bread", 5, SOLID);
...
int main(void) {
    ...
    RUN_TEST(add_ingredient_fail_if_ingredient_with_the_same_name_and_type_already_exists);
